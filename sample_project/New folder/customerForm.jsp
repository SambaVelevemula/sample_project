...
function formvalidate(){
	 ...
	 var filter1= /^\\d+$/;
	 if ((!filter1.test(q1.value)) && (q1.length>=10) ){
	 ...
	 var filter2= /^[a-zA-Z]+$/;
	 if ((!filter2.test(q2.value)) && (q2.length>=10) ){
				alert("Enter charecter names only size lessthan 10");
				return false;
	    }
	 ...
	 if ((!filter.test(q3.value)) && (q3.endsWith('@gmail.com') || q3.endsWith('@yahoo.com'))) {
